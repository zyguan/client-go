...
func NewTiKVExecDetails(pb *kvrpcpb.ExecDetailsV2) TiKVExecDetails {
	...
	td := &TimeDetail{}
	td.MergeFromTimeDetailV2(pb.TimeDetailV2)
	sd := &ScanDetail{}
...
// MergeFromTimeDetailV2 merges time detail from pb into itself.
func (td *TimeDetail) MergeFromTimeDetailV2(timeDetailV2 *kvrpcpb.TimeDetailV2) {
	if timeDetailV2 != nil {
